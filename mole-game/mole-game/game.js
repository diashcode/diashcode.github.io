...
function getNextStatus(mole) {
    ...
    document.querySelector('.worm-container').style.width = `${10 *
    score}%`;
}
...
function nextFrame(){
    ...
    requestAnimationFrame(nextFrame);// u r giving function to the browser & sayin when urnot doing anything ,next tim
}
